...
if __name__ == "__main__":
    ...
    for task in tasks:
        print(f"\n=== Running Optuna for {task} (XGBoost) ===")
        ...
        print(f"\n=== Retraining Top 10 XGBoost models on Train and Testing on Test ({task}) ===")
        for rank, (auc, params_str) in enumerate(results[:10], 1):
            ...
            # 모델 저장
            model_filename = os.path.join(MODEL_DIR, f"xgb_{task}_patients_rank{rank}.pkl")
